...
/**
 * Bento Grid Layout
 * Features a tile-based layout with varying box sizes to create visual hierarchy
 */
export function BentoGridLayout() {
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className={cn(currentStyle.card.container, 'p-4 sm:p-6')}>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Badge className={cn(currentStyle.badge.base, 'bg-blue-500 text-white border border-blue-300')}>
              Planning
            </Badge>
            <Badge className={cn(currentStyle.badge.base, 'bg-purple-500 text-white border border-purple-300')}>
              Completed
            </Badge>
          </div>
        </div>
      ...
      <div className={cn(currentStyle.card.container, 'p-4 sm:p-6')}>
        ...
        <Tabs defaultValue="overview">
          ...
          <TabsContent value="overview" className={currentStyle.tabs.content}>
            <h3 className={cn('text-lg font-semibold mb-2', currentStyle.card.title)}>
              Overview
            </h3>
      ...
      {/* System Notifications - Grid Layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Alert className={cn(currentStyle.alert.base, 'border-l-4 border-blue-500')}>
        ...
        <Alert className={cn(currentStyle.alert.base, 'border-l-4 border-green-500')}>
        ...
        <Alert className={cn(currentStyle.alert.base, 'border-l-4 border-amber-500')}>
        ...
        <Alert className={cn(currentStyle.alert.base, 'border-l-4 border-red-500')}>
