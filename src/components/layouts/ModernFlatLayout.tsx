...
export function ModernFlatLayout() {
    ...
    <div className="w-full space-y-12">
      ...
      <DemoSection title="Account Preferences">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h3 className={cn('text-lg font-semibold', currentStyle.input.label)}>Notifications</h3>
            <div className="space-y-4">
      ...
      <DemoSection title="Project Status">
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          <Badge className={cn(currentStyle.badge.base, 'bg-blue-500 text-white')}>
            Planning
          </Badge>
          <Badge className={cn(currentStyle.badge.base, 'bg-purple-500 text-white')}>
            Completed
          </Badge>
        </div>
        <div className="space-y-6">
      ...
      <DemoSection title="Dashboard">
        <Tabs defaultValue="overview">
          ...
          <TabsContent value="overview" className={currentStyle.tabs.content}>
            <h3 className={cn('text-xl font-bold mb-3', currentStyle.card.title)}>
              Overview
            </h3>
      ...
      <DemoSection title="System Notifications">
        <div className="space-y-4">
          ...
          <Alert className={cn(currentStyle.alert.base, 'border-emerald-500')}>
          ...
          <Alert className={cn(currentStyle.alert.base, 'border-amber-500')}>
